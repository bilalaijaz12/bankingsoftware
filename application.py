# HTML render in python.
# Source: https://stackoverflow.com/questions/46571448/is-it-possible-to-render-html-in-tkinter
# Will need to be recoded.
# Original author content starts below:
...
class BrowserFrame(tk.Frame):
    ...
    def embed_browser(self):
        ...
        self.browser = cef.CreateBrowserSync(window_info,
                                             url="file:///UI/bankingsystem/views/index.ejs") #todo
        assert self.browser
